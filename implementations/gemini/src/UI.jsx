...
export default function UI() {
  const { 
    mode, setMode, reset, 
    selectedWallIds, selectedNodeIds, deleteSelection, addOpening, setWallOpening,
  ...
  return (
    <>
      ...
      {contextMenuData && selectedWallIds.length === 1 && (
        <div 
          className="absolute z-50 bg-white/95 backdrop-blur-sm p-2 rounded-xl shadow-xl border border-white/20 flex flex-col gap-1 animate-in fade-in zoom-in-95 duration-150"
